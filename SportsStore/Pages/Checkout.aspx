    ...
    <div id="content">
        <div id="checkoutForm" runat="server" class="checkout">
            ...
            <div><label for="line1">Line 1:</label>
                <SX:VInput Property="Line1" runat="server" /></div>
            <div><label for="line2">Line 2:</label>
                <SX:VInput Property="Line2" runat="server" /></div>
            <div><label for="line3">Line 3:</label>
                <SX:VInput Property="Line3" runat="server" /></div>
            <div><label for="city">City:</label>
                <SX:VInput Property="City" runat="server" /></div>
            <div><label for="state">State:</label>
                <SX:VInput Property="State" runat="server" /></div>
